...
public class Servlet3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("Exit".equals(button1)) {
            bean.setA(request.getParameter("q7"), 6);
            bean.setA(request.getParameter("q8"), 7);
            bean.setA(request.getParameter("q9"), 8);
            Inputs newInput;
            newInput = new Inputs();
...
//        
        ...
        request.getRequestDispatcher("/WEB-INF/question4.jsp").forward(request, response);
